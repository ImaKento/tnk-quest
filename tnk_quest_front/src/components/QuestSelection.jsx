...
const handleIndividualHunterAchievementDialogClose = () => {
  ...
  const markQuestAsUnread = async (questId) => {
    try {
      const response = await fetch('http://192.168.11.52:3000/markQuestAsUnread/', {
        method: 'POST',
        headers: {
  ...
  const handleEditQuest = async () => {
    try {
      const response = await fetch(`http://192.168.11.52:3000/updateQuest/${selectedEditQuest}/`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleQuestSelect = async (quest) => {
    ...
    try {
        const response = await fetch(`http://192.168.11.52:3000/markQuestAsRead/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
  ...
  const fetchQuestStatus = async () => {
    try {
      const response = await fetch(`http://192.168.11.52:3000/getReadStatus/${hunter}/`, {
